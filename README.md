# Tarea-Trabajo-Colaborativo-Programación I: The last dance
## Integrantes 
- Michael Zavala
- Sebastián Alcívar
## Descripción
Este repositorio fue creado para desarrollar la práctica sobre trabajo colaborativo utilizando GitHub y un sistema de control de versiones.
## Flujo de trabajo realizado 
1. Se creó el repositorio.
2. Se creó la rama Grupo1.
3. Se realizaron cambios en el archivo README.md.
4. Se efectuaron dos commits.
